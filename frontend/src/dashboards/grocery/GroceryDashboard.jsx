...
const GroceryDashboard = () => {
    ...
    useEffect(() => {
        ...
        socket.on("notification:new", (newNotif) => {
            console.log("🔔 Live Update inside Grocery Home:", newNotif);
            refreshData();
            fetchAllData();
        });
        ...
        <div className="space-y-8 pb-24 relative select-none max-w-5xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-slate-100 dark:border-neutral-800/60 pb-4">
                <div>
                    ...
                    <p className="text-[11px] font-semibold text-slate-500 dark:text-neutral-400 mt-1">
                        Store: <span className="text-indigo-600 dark:text-indigo-400 font-bold">{user.shopDetails?.shopName || 'Green Valley Grocers'}</span>
                    </p>
                </div>
            ...
            <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    {/* Orders Today */}
                    <div className="p-5 rounded-3xl bg-white dark:bg-neutral-900 border border-slate-200/50 dark:border-neutral-800/80 shadow-md flex flex-col justify-between min-h-[160px]">
                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-neutral-555 block">Orders Today</span>
                        <div className="text-3xl font-black text-slate-800 dark:text-neutral-100 tracking-tight my-1.5">
                            {ordersTodayVal}
                        </div>
                        <div className="flex items-center gap-2 mt-auto text-[10px] text-slate-400 dark:text-neutral-555 font-semibold">
                            <span className="text-indigo-555 dark:text-indigo-400 font-black">{ordersPendingCount} Pending</span>
                            <span>|</span>
                ...
                <div className="p-6 rounded-3xl bg-white dark:bg-neutral-900 border border-slate-200/50 dark:border-neutral-800/80 shadow-md space-y-4">
                    ...
                    <div className="space-y-3 pt-1">
                        {[
                            ...
                            <div key={idx} className="p-3 bg-slate-55 dark:bg-neutral-955 border border-slate-100 dark:border-neutral-850 rounded-2xl flex items-center justify-between transition-all hover:translate-x-1 duration-200">
                                <div className="flex items-center gap-3">
                                    <span className="text-lg">{pulse.icon}</span>
                                    <span className="text-xs font-bold text-slate-700 dark:text-neutral-350">{pulse.name}</span>
                                </div>
                                <div className="flex items-center gap-2">
                ...
                <div className="p-6 rounded-3xl bg-white dark:bg-neutral-900 border border-slate-200/50 dark:border-neutral-800/80 shadow-md space-y-4">
                    ...
                    <div className="space-y-3 pt-1">
                        {[
                            ...
                            <div key={idx} className="flex items-start gap-2.5 text-xs text-slate-650 dark:text-neutral-355">
