            ...
            <div className="max-w-4xl mx-auto space-y-16">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-text-secondary max-w-2xl mx-auto text-lg">
                        Simple steps to get the most out of ShopLens.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    {/* What is ShopLens */}
                    <SectionCard title="What is ShopLens?">
                        <p className="mb-4">ShopLens helps you find nearby local shops and see what they have available—before you step out.</p>
                        <p className="text-accent-end font-medium">If a product shows “In Stock” on ShopLens, it means it is available at the shop right now.</p>
                    </SectionCard>

                    {/* Trust & Safety */}
                    <SectionCard title="Trust & Safety">
                        <p className="mb-4">Every shop on ShopLens goes through a verification process.</p>
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    <div className="space-y-6">
                        ...
                        <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                            <p className="text-text-secondary mb-4">ShopLens gives your shop a simple digital presence:</p>
                            <ul className="space-y-3 text-text-primary">
                                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-mint rounded-full mr-3"></span>Create a shop profile</li>
                            ...
                            <p className="mt-4 text-sm text-text-tertiary">Customers nearby can discover your shop and contact you directly. No technical skills required.</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                            <p className="text-text-secondary mb-4">With ShopLens, you can:</p>
                            <ul className="space-y-3 text-text-primary">
                                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-accent-end rounded-full mr-3"></span>Discover nearby shops</li>
                ...
                <div className="bg-gradient-to-r from-background to-white/5 border border-white/10 rounded-3xl p-8 md:p-12 text-center">
                    ...
                    <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-16">
                        <div className="flex-1">
                            <h3 className="text-xl font-bold text-accent-end mb-2">Buyers</h3>
                            <p className="text-text-secondary">Simply search nearby shops</p>
                        </div>
                        <div className="flex-1">
                            <h3 className="text-xl font-bold text-mint mb-2">Sellers</h3>
                            <p className="text-text-secondary">List your shop and wait for verification</p>
                        </div>
                    </div>
